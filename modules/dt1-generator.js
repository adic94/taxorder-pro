...
window.DT1Generator = {
  ...
  text(page, txt, x, y, size=8, bold=false, color=null) {
    ...
    }); } catch(e) { try { page.drawText(_pl2ascii(String(txt)), { x, y: this.H - y - size, size, font: bold ? this.FONT_BOLD : this.FONT_MONO, color: color || this.col('black') }); } catch(e2) { console.warn('[DT1]',e2.message); } }
  },
