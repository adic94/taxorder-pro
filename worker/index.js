...
{"nrRej":"pole A np WA4789F","dataRej":"pole B format DD.MM.RRRR","marka":"pole D.1","typ":"pole D.2 typ/model","vin":"pole E 17 znakow","dmcKg":"pole F.1 kg z ŻÓŁTEJ tabeli rejestracyjnej — jeśli widzisz dwie różne wartości F.1 (np. 16285 i 27000) wybierz WIĘKSZĄ bo to wartość z tabeli","dmcKg2":"pole F.2 kg","dmcZespolu":"pole F.3 kg musi być >= F.1","masaWlKg":"pole G kg masa własna musi być < F.1","liczbaOsi":"pole L cyfra 1-5","kategoria":"pole J np N1 N2 N3 M1","pojSilnika":"pole P.1 tylko cyfry cm3","mocKW":"pole P.2 tylko cyfry kW","paliwo":"pole P.3: D=ON B=benzyna G=LPG","miejscaSied":"pole S.1 tylko cyfry","rokProd":"rok produkcji 4 cyfry"}`;
