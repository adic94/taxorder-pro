...
1. **Pełne porównanie tabel** (repo: 134 definicje `CREATE TABLE` w `schema_v*.sql`):
   ...
   automatem wypadnie czerwono i tak ma być** — to 5 realnie brakujących tabel i 10 na
